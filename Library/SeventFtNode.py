...
[name, response] = request.urlretrieve(baseUrl + 'Library/SeventFtC4.py', '_SeventFtC4.py')
from _SeventFtC4 import Container, Persona, Database, System, Component, Code, System
